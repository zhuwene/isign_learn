<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:37:"themes/97013266/portal/supposted.html";i:1625292402;s:32:"themes/97013266/public/head.html";i:1625292402;s:36:"themes/97013266/public/function.html";i:1625292402;s:31:"themes/97013266/public/nav.html";i:1625292402;s:34:"themes/97013266/public/footer.html";i:1625292402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<script src="__TMPL__/public/assets/js/plist_parser.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp60e038c20e266,null,false);
 ?>
</head>
...
function __parse_navigationcc67bc4877c44be1f1a96286b978fe32($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationcc67bc4877c44be1f1a96286b978fe32';
...
if(''==''): ?>
    <?php echo __parse_navigationcc67bc4877c44be1f1a96286b978fe32($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationcc67bc4877c44be1f1a96286b978fe32($menus); ?>
    </>
<?php endif; ?>
...
<div id="footer" style="bottom: 0px;height: 80px;background:#ECECEC;width: -webkit-fill-available">
    <?php 
    \think\Hook::listen('footer_start',$temp60e038c20e273,null,false);
 ?>
    <div class="links">
        <?php
