<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"themes/admin_simpleboot3/admin/login.html";i:1625292402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
    <title>zwe猫签zwe <?php echo lang('ADMIN_CENTER'); ?></title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <h1 class="text-center">zwe猫签zwe</h1>
