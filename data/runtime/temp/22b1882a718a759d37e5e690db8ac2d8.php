<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"themes/97013266/portal/distribute_sign.html";i:1625292402;s:32:"themes/97013266/public/head.html";i:1625292402;s:36:"themes/97013266/public/function.html";i:1625292402;s:31:"themes/97013266/public/nav.html";i:1625292402;s:34:"themes/97013266/public/footer.html";i:1625292402;s:35:"themes/97013266/public/scripts.html";i:1625292402;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>内测分发 <?php echo (isset($site_info['site_name']) && ($site_info['site_name'] !== '')?$site_info['site_name']:''); ?></title>
...
<script src="__TMPL__/public/assets/js/plist_parser.js"></script>
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp60e039193427f,null,false);
 ?>
    <style>
        .bogo-content {
            margin-top: 100px;
...
function __parse_navigationaaf50cedb1adeb1e744ce5a589c77678($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationaaf50cedb1adeb1e744ce5a589c77678';
...
if(''==''): ?>
    <?php echo __parse_navigationaaf50cedb1adeb1e744ce5a589c77678($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationaaf50cedb1adeb1e744ce5a589c77678($menus); ?>
    </>
<?php endif; ?>
...
<div class="sup-bottom">
    <div class="sup-bottom-box">
        <div class="sup-bottom-box-a">
            <p class="sup-bottom-box-apleft">不一样的 iOS 下载<br/>不一样的优点</p>
        </div>
        <div class="sup-bottom-box-a ">
...
<div id="footer" style="bottom: 0px;height: 80px;background:#ECECEC;width: -webkit-fill-available">
    <?php 
    \think\Hook::listen('footer_start',$temp60e039193428c,null,false);
 ?>
    <div class="links">
        <?php
